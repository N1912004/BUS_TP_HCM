...
<div class="card">
    <div class="card-body">
        <form action="<?php echo e(route('admin.assistants.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.admin.index_admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/laravelversion1.com/resources/views/backend/admin/assistants/create.blade.php ENDPATH**/ ?>