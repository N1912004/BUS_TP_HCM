...
<body class="login-page">
    ...
    <main class="main">
        <div class="login-card">
            ...
            <?php endif; ?>
            <form method="POST" action="<?php echo e(route('auth.login_admin')); ?>">
                <?php echo csrf_field(); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/laravelversion1.com/resources/views/backend/auth/login_ad_bus.blade.php ENDPATH**/ ?>