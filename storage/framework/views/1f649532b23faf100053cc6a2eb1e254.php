        ...
        <div class="card">
            <div class="card-content">
                ...
                <div class="options">
                    ...
                    <div class="option blue"></div>
                    <div class="option white">
                        <a href="<?php echo e(route('auth.dashboard_user')); ?>" class="option white">
...
<?php /**PATH C:\Users\pc\Downloads\BUS_TP_HCM-main\BUS_TP_HCM-main\resources\views/backend/auth/Roles.blade.php ENDPATH**/ ?>